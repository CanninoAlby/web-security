...
class GalleryRoutes extends BaseRoutes_1.default {
    routes() {
        ...
        this.router.post("/", AuthMiddleware_1.auth, UploadMiddleware_1.default, GalleryController_1.default.create);
        this.router.get("/:id", AuthMiddleware_1.auth, GalleryController_1.default.show);
        this.router.put("/:id", AuthMiddleware_1.auth, UploadMiddleware_1.default, GalleryController_1.default.update);
